...
public class NaiveBayesClassifierAccuracyCheck {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(NaiveBayesClassifierAccuracyCheck.class);
...
//        Dataset<Row> rescaledData = idfModel.transform(featurizedData);
        ...
        NaiveBayesModel model = new NaiveBayes().fit(trainingData);
        ...
        LOGGER.info("Result for Naive Bayes");
